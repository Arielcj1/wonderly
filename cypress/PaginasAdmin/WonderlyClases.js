...
export class WonderlyClases {
  click_iconoAgregarMaterial() {
    cy.xpath(
      "/html/body/div[2]/div[2]/div/div/div/main/article/div[2]/table/tbody/tr[1]/td[6]/a[3]"
    ).click();
  }
  ...
  verificar_Material() {
    cy.xpath(
      "/html/body/div[2]/div[2]/div/div/div/main/article/div[2]/div/form/div[1]/div/div[1]/div/table/tbody[2]/tr/td/text()"
    )
      .invoke("text")
      .then((text3) => {
        ...
        if (material == "No hay") {
          ...
          cy.xpath(
            "/html/body/div[2]/div[2]/div/div/div/main/article/div[2]/div/form/div[1]/div/div[1]/div/table/tbody[1]/tr[1]/td[4]/ul/li[2]/button"
          ).click();
        }
      });
  }
  ...
  click_nombreClase() {
    cy.xpath(
      "/html/body/div[2]/div[2]/div/div/div/main/article/div[2]/table/tbody/tr[1]/td[2]/a"
    ).click();
  }
}
