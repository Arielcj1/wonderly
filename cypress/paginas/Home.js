...
export class Home{
    ...
    click_clases_sinRegistro(){
        ...
        cy.xpath('/html/body/div[2]/div[3]/div/div/div/main/article/div/section[2]/div[3]/div/div/div/div/div[1]/div/div/div[3]/button').click()
    }

    click_clase_conRegistro(){
        cy.xpath('/html/body/div[2]/div[2]/div/div/div/main/article/div/section[2]/div[3]/div/div/div/div/div[1]/div/div/div[3]/button').click()
    }
    ...
    click_clase(){
        ...
        click_clase_Cancelar(){
            //cy.get('#2247').click()
            cy.get('#2247').invoke('text').then((text)=>{
                if(text != 'Reservar mi clase'){
                    cy.get('#2247').click()
                }else{
        ...
        click_Membresia_Explorador(){
            cy.get('.slick-current > :nth-child(1) > .mb-3 > .description > .btn').click()
        }
    
        click_Membresia_Inventor(){
            cy.get('[data-slick-index="1"] > :nth-child(1) > .mb-3 > .description > .btn').click()
        }
