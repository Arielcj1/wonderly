...
export class ComprarPaquete {
  ...
  verificarTipoMembresia(membresia) {
    cy.xpath(
      "/html/body/div[2]/div[2]/div/div/div/main/article/div[2]/div/div/div/div/p[1]/text()"
    )
      .invoke("text")
      .then((text) => {
        if (text == membresia) {
  ...
  verificarPrecioTotal(precio) {
    cy.xpath(
      "/html/body/div[2]/div[2]/div/div/div/main/article/div[2]/div/div/div/div/p[5]/text()"
    )
      .invoke("text")
      .then((text) => {
        if (text == precio) {
