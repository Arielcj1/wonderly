...
describe("Wonderly- PROFESOR", () => {
  ...
  it("11_1_Comprobar que un hijo pueda inscribirse a una clase entrando al detalle de la clase", () => {
    ...
    home.click_IniciaSesion();
    ingresar.type_Correo("belenarancibia@mailinator.com"); //Cambiar el correo del padre nuevo
  ...
  it("14_Verificar que un profesor pueda Iniciar clase desde el Schedule", () => {
    home.click_LogoWonderly();
    home.click_seccionEnVivo();
    clasesprofesor.boton_iniciarClaseSchedule("Iniciar Clase");
  });

  it("15_Verificar que un profesor pueda ver sus clases asignadas desde el schedule", () => {
    home.click_LogoWonderly();
    home.click_seccionEnVivo();
    clasesprofesor.verificarClaseAsignadaSchedule("Iniciar Clase");
  });

  it("16_Verificar que un profesor puede editar su clase.", () => {
  ...
  it("17_Verificar que un profesor puede agregar material a su clase", () => {
    clasesprofesor.tableroClasesProfesor();
  ...
  it("18_Verificar que un profesor puede eliminar material de su clase", () => {
    clasesprofesor.tableroClasesProfesor();
    clasesprofesor.iconoAgregarMaterial();
  ...
  it("19_Verificar que un profesor puede editar material a su clase", () => {
    clasesprofesor.tableroClasesProfesor();
    clasesprofesor.iconoAgregarMaterial();
    clasesprofesor.AgregarMaterial2davez(
      "Titulo ",
  ...
  it("20_Verificar que el material agregado por el profesor respeta los formatos permitidos y el tamaño maximo de archivo", () => {
    clasesprofesor.tableroClasesProfesor();
    clasesprofesor.iconoAgregarMaterial();
    clasesprofesor.click_botonAgregarMaterial();
  ...
  it("22_Verificar que el profesor pueda ver el detalle de una clase seleccionada", () => {
    clasesprofesor.tableroClasesProfesor();
    clasesprofesor.click_nombreClase();
  ...
  it("26_Comprobar que un profesor pueda ver el mensaje cuando no se han inscrito alumnos a su clase", () => {
    perfil.click_salirDelMenu();
    home.click_IniciaSesion();
